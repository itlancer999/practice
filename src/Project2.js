...
export const Project2 = () => (
  ...
  <Container className="project">
    <h2 pt-5>Cutting Edge Insights: A Case Study on Hairdresser Availability in Town</h2>
    <Row className="tags">
      <Col>
    ...
    <div className="p-5">
      ...
      <p className="pt-2">The Salon Booking Platform is a user friendly web application facilitating seemless salon appointments scheduling in a small town.  Users discover nearby salons and stylists, explore detailed stylist profiles, and effortlessly book appointments. With personalized user profiles, managing bookings is convenient and hassle free of calling to local salons to check there favorite stylists availability. This platform simplifies the salon booking process, enhancing the user experience for both clients and stylists.</p>
    <h2 className="tags">Problem</h2>
    <h2 className="pt-2">Salons solely rely on phone calls for appointments; no online booking system available.</h2>
    <h3 className="pt-2">It is difficult for many people to manage busy schedule and stay groomed for best performance.</h3>
    <p className="pt-2">The exclusive reliance on phone calls to schedule salon appointments in our town creates inefficiencies and inconveniences for both salon owners and clients. Clients must navigate through busy phone lines and potential delays to inquire about available time slots, leading to frustration and uncertainty about securing desired appointments. Salon owners, meanwhile, face challenges in managing a high volume of phone inquiries, which can disrupt salon operations and result in missed opportunities to fill appointment slots efficiently. This manual booking process limits accessibility for clients and impedes the salon's ability to optimize scheduling and improve customer satisfaction.</p>
    <Row className="pt-5 splitter">
      ...
      <h2 className="pt-2">A user-friendly salon platform app for seamless booking & efficient salon management.</h2>
      <p className="pt-2">The proposed solution involves developing a dedicated mobile application designed specifically for salon online booking. This application will offer a user-friendly interface for clients to easily browse available appointments, select preferred time slots, and book services with their chosen salon.</p>
      <p className="pt-2">By introducing this digital solution, both clients and salon owners will benefit from enhanced convenience, accessibility, and efficiency in the appointment scheduling process, ultimately leading to improved customer satisfaction and salon performance.</p>
      </Col>
    </Row>
